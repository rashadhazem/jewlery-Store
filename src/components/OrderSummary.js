            ...
            {selectedProduct && (
              <>
                ...
                <Box sx={{ textAlign: 'center' }}>
                  <Button variant="contained" color="primary" onClick={handleCloseModal} sx={{ mr: 2 }}>
                    Close
                  </Button>
                  <Button variant="outlined" color="secondary" onClick={() => handleAddToCart(selectedProduct)}>
                    Add to Cart
                  </Button>
                </Box>
              </>
